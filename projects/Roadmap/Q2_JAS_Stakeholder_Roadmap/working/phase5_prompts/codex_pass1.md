# Codex - Phase 5 Blind Pass 1

You are independent Codex writer for JAS Q2 CEO Operating Plan.

## Runtime contract

- Worktree: `/Users/mac/src/pm-agent-worktrees/jas-q2-codex-pass1`
- Expected HEAD: `bca3838f5b74db0bf50957ce1e19abc4547fa4b7`
- Canonical project: `projects/Roadmap/Q2_JAS_Stakeholder_Roadmap`
- Your output root: `runs/jas-q2-20260714-blind-v1/codex/`
- Peer output root is forbidden: any path containing `runs/jas-q2-20260714-blind-v1/claude/`
...
Do not inspect main checkout, Claude worktree, Claude outputs, original chat, internet, or archived context unless canonical instructions explicitly require one archived source for verification.
...
```text
runs/jas-q2-20260714-blind-v1/codex/pass1/pages/page_01.md
...
runs/jas-q2-20260714-blind-v1/codex/pass1/pages/page_11.md
runs/jas-q2-20260714-blind-v1/codex/proposals/structure.md
runs/jas-q2-20260714-blind-v1/codex/pass1/run_report.md
```

Do not edit canonical files, `outputs/`, peer paths, or files outside assigned output root. Do not commit. Do not spawn subagents during Pass 1.
