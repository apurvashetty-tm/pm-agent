...
- **`ring-ai/`** — AI voice pre-qualification via Ring AI, the first vendor in this space. Current build: the PM-led **AI-led Lead Qualification** platform PRD (Confluence PROD page 2023260174); the earlier Rapid Pilot bolt-on is historical. See `ring-ai/CLAUDE.md`.
...
- Confluence: *AI-led Lead Qualification* (page 2023260174, space PROD) — current Ring AI build, not the umbrella
- Confluence: *ACOM 2.0 — Ring AI Rapid Pilot PRD* (page 1850114059, space PROD) — historical Ring pilot, superseded
